...
維度（總分 100）：動能 60（vol-adjusted 12-1 百分位）＋趨勢 25＋量能 15。
籌碼/營收 美股無 → None（前端欄位留空，與舊行為一致）。
"""
...
W_MOM, W_TREND, W_VOL = 60.0, 25.0, 15.0
